  ...
  const renderGoogleButton = () => (
    <div className="space-y-3">
      ...
      <button
        ...
        disabled={submitting}
        className="w-full flex items-center justify-center gap-2 text-xs font-mono py-2.5 px-3 rounded-md border border-border bg-secondary/50 hover:bg-secondary text-foreground transition-all disabled:opacity-50"
      >
